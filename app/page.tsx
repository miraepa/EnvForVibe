...
const guideData = [
  ...
  },
  {
    ...
    tasks: [
      "Antigravity의 터미널에서 다음과 같이 명령어를 차례대로 입력합니다.<br><img src='/vibe1.png' alt='Vibe Coding' class='mt-4 w-full max-w-[800px] rounded-lg shadow-md border border-indigo-100'>",
      "생성된 프로젝트를 Antigravity로 연결 합니다.<br><img src='/vibe2.png' alt='Vibe Step 1' class='mt-4 w-full max-w-[300px] rounded-lg shadow-md border border-indigo-100'><img src='/vibe3.png' alt='Vibe Step 2' class='mt-4 w-full max-w-[600px] rounded-lg shadow-md border border-indigo-100'><img src='/vibe3.png' alt='Vibe Step 3' class='mt-4 w-full max-w-[800px] rounded-lg shadow-md border border-indigo-100'><img src='/vibe4.png' alt='Vibe Step 4' class='mt-4 w-full max-w-[800px] rounded-lg shadow-md border border-indigo-100'>",
